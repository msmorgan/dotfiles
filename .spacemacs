...
you should place your code here."
  ;; Intero
  (setq intero-package-version "0.1.24")

  ;; Idris
  (custom-theme-set-faces
   'spacemacs-dark
   '(idris-equals-face ((t (:inherit bold))))
   '(idris-colon-face ((t (:inherit bold))))
   '(idris-hole-face ((t (:underline (:color "#006DAF" :style wave) :slant italic))))
   '(idris-operator-face ((t (:inherit bold))))
   ...
   '(idris-directive-face ((t (:inherit font-lock-preprocessor-face))))
   '(idris-inline-doc-face ((t (:inherit font-lock-comment-face))))
